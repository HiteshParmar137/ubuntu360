export class Constants {
  ...
  static readonly USERGROUP = '/admin/user_groups/list';
  static readonly SIDEBAR = 'get_sidebar';
  static readonly GETSYSTEMMODULES = '/admin/user_groups/get-all-modules';
  ...
  static readonly USERGROUPDETAIL = '/admin/user_groups/';
  static readonly USERGROUPCREATE = '/admin/user_groups/create';
  static readonly USERGROUPUPDATE = '/admin/user_groups/edit';
  static readonly USERGROUPDELETE = '/admin/user_groups/delete/';
  ...
  static readonly VERIFY_EMAIL = 'admin_verified_email';
  ...
  static readonly PROJECTSTATUSARR = [
    { id: "Draft", name: "Draft" },
    { id: "Pending", name: "Pending" },
    { id: "Completed by Owner", name: "Completed by Owner" },
    { id: "Goal Reached", name: "Goal Reached" },
