/*
  ...
  jQuery.Link (part of noUiSlider) - WTFPL */
(function(c) {
    function m(a, c, d) {
    ...
    r.prototype.w =
        function(a) {
            function c(a) {
                return a.replace(/[\-\/\\\^jQuery*+?.()|\[\]{}]/g, "\\jQuery&")
            }
            var d;
            ...
            a = a.replace(RegExp(c(this.a("postfix")) + "jQuery"), "").replace(RegExp(c(this.a("thousand")), "g"), "").replace(this.a("mark"), ".");
...
/*
  ...
  jQuery.fn.noUiSlider - WTFPL - refreshless.com/nouislider/ */
(function(c) {
    function m(e) {
        ...
        function u(d, p, e) {
            ...
            jQuery(window).bind("load resize", function () {
                if (jQuery(window).width() > 1100) {
                    p = Math.max(Math.min(parseFloat(p.toFixed(7)), 100 - 9), 0);

                } else if (jQuery(window).width() > 1000) {
                    p = Math.max(Math.min(parseFloat(p.toFixed(7)), 100 - 4), 0);
                }
                else if (jQuery(window).width() < 800) {
                    p = Math.max(Math.min(parseFloat(p.toFixed(7)), 100 - 6), 0);
                }
            }).resize();
