...
export class GeneralService {
  ...
  private siteSettingsData = new BehaviorSubject({});
  public siteSettingsDataListener = this.siteSettingsData.asObservable();
  ...
  siteSettingData(data: any) {
    this.siteSettingsData.next(data);
  }
  passData(data: any) {
